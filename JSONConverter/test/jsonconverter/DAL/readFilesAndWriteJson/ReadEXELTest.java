 ...
 * @author Pepe15224
 */
public class ReadEXELTest extends TestCase {
    
    public ReadEXELTest(String testName) {
        super(testName);
    }

    /**
     * Test of getFileHeaders method, of class ReadEXEL.
     */
    public void testGetFileHeaders() {
        System.out.println("ReadEXELTest : testFileHeaders");
        ReadEXEL instance = new ReadEXEL("test/testFiles/testEXEL.xlsx");
    ...
    public void testGetFileHeadersOutput(HashMap<String, Integer> result) {
        ...
        expectedGood1.put("firstHeaher", 0);
        ...
        expectedGood2.put("firstHeaher", 0); 
        ...
        expectedBad2.put("firstHeaher", 3); 
        ...
        expectedBad4.put("thirdHeaher", 0);
        
        assertNotSame(expectedBad4, result);
       
    }
    /**
     * Test of getFileValues method, of class ReadEXEL.
     */
    public void testGetFileValues() {
        System.out.println("ReadEXELTest : testGetFileValues");
        ReadEXEL instance = new ReadEXEL("test/testFiles/testEXEL.xlsx");
    ...
    /**
     * Test of getOnlyFileHeaders method, of class ReadEXEL.
     */
    public void testGetOnlyFileHeaders() {
        System.out.println("ReadEXELTest : testGetOnlyFileHeaders");
        ReadEXEL instance = new ReadEXEL("test/testFiles/testEXEL.xlsx");
