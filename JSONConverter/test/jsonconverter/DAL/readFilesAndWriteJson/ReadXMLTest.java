...
public class ReadXMLTest extends TestCase {
    ...
    public ReadXMLTest(String testName) {
        super(testName);
    }

    /**
     * Test of getFileHeaders method, of class ReadXML.
     */
    public void testGetFileHeaders() {
        System.out.println("ReadXMLTest : testFileHeaders");
        ReadXML instance = new ReadXML("test/testFiles/testXML.xml");
    ...
    /**
     * Test of getFileValues method, of class ReadXML.
     */
    public void testGetFileValues() {
        System.out.println("ReadXMLTest : testGetFileValues");
        ReadXML instance = new ReadXML("test/testFiles/testXML.xml");
    ...
    /**
     * Test of getOnlyFileHeaders method, of class ReadXML.
     */
    public void testGetOnlyFileHeaders() {
        System.out.println("ReadXMLTest : testGetOnlyFileHeaders");
        ReadXML instance = new ReadXML("test/testFiles/testXML.xml");
